...
def main():
    ...
    diff_parser = subparsers.add_parser("diff", help="find inputs where two expressions differ")
    ...
    cmp_parser.add_argument("-i", "--interactive", action="store_true", help="launch shell afterwards (run dir())")
